...
from .serializers import CommentVoteSerializer, LoanrequestVoteSerializer


class CreateVoteView(CreateAPIView):
    comment_serializer_class = CommentVoteSerializer
    loanrequest_serializer_class = LoanrequestVoteSerializer
    ...
    def get_serializer(self, *args, **kwargs):
        ...
        if fn[0:3] == "t1_":
            ...
            data["loanrequest"] = fn[3:]
            return self.loanrequest_serializer_class(data=data)
